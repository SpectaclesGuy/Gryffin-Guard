...
dict_int_to_char = {'0':'O','1':'I', '3':'J', '4':'A', '6':'G', '5':'S', '1' : 'T'}
...
def write_csv(results, output_path):
    ...
    with open(output_path, 'w') as f:
        f.write('{},{},{},{},{},{},{},{}\n'.format(
            ...
            'license_plate_bbox_score', 'license_number', 'license_number_score', 'entry_time'
        ))

        for frame_nmr in results.keys():
            for car_id in results[frame_nmr].keys():
                if car_id in written_car_ids:
                    continue
                ...
                if 'car' in results[frame_nmr][car_id].keys() and \
                   ...
                   'text' in results[frame_nmr][car_id]['license_plate'].keys():
                    f.write('{},{},{},{},{},{},{},{}\n'.format(
                        ...
                        results[frame_nmr][car_id]['entry_time'] 
                    ))
                    written_car_ids.add(car_id)
    f.close()
